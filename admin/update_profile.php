...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="text" name="name" value="<?= $fetch_profile['name']; ?>" required placeholder="nhập username" maxlength="20"  class="box" oninput="this.value = this.value.replace(/\s/g, '')">
      ...
      <input type="password" name="confirm_pass" placeholder="xác nhập mật khẩu mới" maxlength="20"  class="box" oninput="this.value = this.value.replace(/\s/g, '')">
