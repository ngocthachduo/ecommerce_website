...
<h1 class="heading">Đơn hàng hiện có</h1>
...
<div class="box-container">
   ...
   <div class="box">
      ...
      <p> phương thức mua hàng : <span><?= $fetch_orders['method']; ?></span> </p>
      <form action="" method="post">
        ...
        <div class="flex-btn">
         ...
         <a href="placed_orders.php?delete=<?= $fetch_orders['id']; ?>" class="delete-btn" onclick="return confirm('delete this order?');">xoá</a>
        </div>
      </form>
   </div>
   <?php
